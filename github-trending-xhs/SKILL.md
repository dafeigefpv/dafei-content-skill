...
- `copy`：发布文案 {title, body, title_alts, tags}。**body 是 5 张详情卡内容的进一步丰富和补充（不是摘要），1000 字以内（含换行符，按最严口径；写完必须用脚本实测字符数）**。
...
- tags 统一 22 个定版清单（2026-09-09）：#GitHub #开源项目 #AI编程 #程序员日常 #AIAgent #智能体 #技能日报 #项目日报 #每天一个神仙技能 #每天一个Github热门项目 #大飞的AI赋能笔记 #AI #skill #技能 #workbuddy #codex #claudecode #opencode #openclaw #hermes #豆包 #deepseek（与 content.json 保持一致，整份照抄不增不减）
