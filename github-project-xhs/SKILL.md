...
- `copy` {title, body, title_alts, tags}：**与 trending 版同一套基础红线**——body 1000 字内（含换行，写完脚本实测）、少黑话多"你"口吻、数字与事实一致；结尾关注引导用"每天定点"（不写具体时间点）；tags 统一 22 个定版清单（2026-09-09）：#GitHub #开源项目 #AI编程 #程序员日常 #AIAgent #智能体 #技能日报 #项目日报 #每天一个神仙技能 #每天一个Github热门项目 #大飞的AI赋能笔记 #AI #skill #技能 #workbuddy #codex #claudecode #opencode #openclaw #hermes #豆包 #deepseek（与 content.json 保持一致，整份照抄不增不减）
